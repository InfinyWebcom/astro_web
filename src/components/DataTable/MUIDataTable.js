...
class MUIDataTable extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.options.page !== Number(this.state.page)) {
      this.setState({ page: this.props.options.page })
    }
  ...
  changeRowsPerPage = rows => {
    ...
    this.setState(
      () => ({
        rowsPerPage: rows,
        page: getPageValue(rowCount, rows, Number(this.state.page)),
      }),
      () => {
    ...
    this.setState(
      ...
      () => {
        ...
        if (this.options.onChangePage) {
          this.options.onChangePage(Number(this.state.page));
        }
      },
    );
  };
