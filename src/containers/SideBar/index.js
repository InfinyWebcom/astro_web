...
const SideBar = (props) => {
  ...
  console.log("navCollapsed in drawer file", type, navCollapsed, props)
  return (
    <div className={`app-sidebar d-none ${drawerStyle}`}>
      ...
      >
        ...
        <div className='logo-container'>
          ...
          <img src={require("assets/images/logo.png")} className='astroLogo' alt="AstroWize" title="AstroWize" />
        </div>
      </Drawer>
    </div>
  );
