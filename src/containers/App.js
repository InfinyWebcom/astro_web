...
import VerifyOtp from './resetPassword'
...
class App extends Component {
    ...
    render() {
        ...
        const { match, location, isDarkTheme, locale, initURL, isDirectionRTL, darkTheme, themeColor } = this.props;
...
export default withRouter(connect(mapStateToProps, { setInitUrl, setThemeColor, setDarkTheme })(App));
